...
DivElement buildRepoGrid(List<Repo> repos, {String sortKey = ''}) => div(
  ...
  children: [for (var i = 0; i < repos.length; i++) buildRepoTile(repos[i], i)],
);
...
DivElement buildEmptyState() => div(
  ...
  child: pEl('No repositories found.', className: 'blog-subtitle'),
);
...
DivElement buildLoadingState() => div(
  ...
  style: {'textAlign': 'center', 'padding': '48px'},
  child: pEl('Loading repositories...', className: 'blog-subtitle'),
);

/// Build error state
DivElement buildErrorState(String error) => div(
  className: 'error-state',
  style: {'textAlign': 'center', 'padding': '48px', 'color': 'var(--danger)'},
  child: pEl('Error: $error', className: 'blog-subtitle'),
);
